...
if %Hide%==1 ( 
    ...
    echo ::::::::::::: ---------------------------------------------------------------------------------------- ::::::::::::: >> %LogFileName%
    npm run StartServer >> %LogFileName% 2>&1
...
if %Hide%==1 ( 
    ...
    echo ::::::::::::: ------------------------------ %_date% ---------------------------------- ::::::::::::: >> %LogFileName%
    echo ::::::::::::: ---------------------------------------------------------------------------------------- ::::::::::::: >> %LogFileName%
    npm run StopServer >> %LogFileName% 2>&1
...
if %Hide%==1 ( 
    ...
    echo ::::::::::::: ---------------------------------------------------------------------------------------- ::::::::::::: >> %LogFileName%
    npm run RestartServer >> %LogFileName% 2>&1
...
if %Hide%==1 ( 
    ...
    echo ::::::::::::: ------------------------------ %_date% ---------------------------------- ::::::::::::: >> %LogFileName%
    echo ::::::::::::: ---------------------------------------------------------------------------------------- ::::::::::::: >> %LogFileName%
    npm run DeleteServer >> %LogFileName% 2>&1
